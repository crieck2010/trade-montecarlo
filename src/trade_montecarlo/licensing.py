...
PRODUCT = "trade-montecarlo"
CURRENT_VERSION = "0.1.0"
UPDATE_URL = "https://api.github.com/repos/crieck2010/trade-montecarlo/releases/latest"
...
def check_license(key: str | None = None) -> dict:
    ...
    changing call sites.
    """
    key = key or os.environ.get("TRADE_MONTECARLO_LICENSE", "")
